...
def main():
  ...
  vst3_bundle = build_dir + "\\TroisCorpsWave.vst3"
  ...
  if not zip:
    installer = "\\build-win\\installer\\TroisCorpsWave Installer.exe"

    if demo:
      installer = "\\build-win\\installer\\TroisCorpsWave Demo Installer.exe"

    files = [
      projectpath + installer,
      projectpath + "\\installer\\changelog.txt",
      projectpath + "\\installer\\known-issues.txt",
      projectpath + "\\build-win\\manual\\TroisCorpsWave manual.pdf"
    ]
    ...
    vst3_bundle = projectpath + "\\build-win\\TroisCorpsWave.vst3"
    if os.path.exists(vst3_bundle):
      add_folder_to_zip(zf, vst3_bundle, "TroisCorpsWave.vst3")

    # Add standalone executables
    files = [
      projectpath + "\\build-win\\TroisCorpsWave_x64.exe",
      projectpath + "\\build-win\\TroisCorpsWave_ARM64EC.exe",
    ]
    ...
    clap_files = [
      # Postbuild locations
      (projectpath + "\\build-win\\TroisCorpsWave_x64.clap", "TroisCorpsWave_x64.clap"),
      (projectpath + "\\build-win\\TroisCorpsWave_ARM64EC.clap", "TroisCorpsWave_ARM64EC.clap"),
      # Build output locations (fallback)
      (projectpath + "\\build-win\\clap\\x64\\Release\\TroisCorpsWave.clap", "TroisCorpsWave_x64.clap"),
      (projectpath + "\\build-win\\clap\\ARM64EC\\Release\\TroisCorpsWave.clap", "TroisCorpsWave_ARM64EC.clap"),
    ]
  ...
  files = [
    projectpath + "\\build-win\\pdbs\\TroisCorpsWave-vst3_x64.pdb",
    projectpath + "\\build-win\\pdbs\\TroisCorpsWave-vst3_ARM64EC.pdb",
    projectpath + "\\build-win\\pdbs\\TroisCorpsWave-app_x64.pdb",
    projectpath + "\\build-win\\pdbs\\TroisCorpsWave-app_ARM64EC.pdb",
    projectpath + "\\build-win\\pdbs\\TroisCorpsWave-clap_x64.pdb",
    projectpath + "\\build-win\\pdbs\\TroisCorpsWave-clap_ARM64EC.pdb"
  ]
