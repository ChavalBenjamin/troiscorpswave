...
NOTARIZE_BUNDLE_ID=com.BEnjaminChaval.TroisCorpsWave
NOTARIZE_BUNDLE_ID_DEMO=com.BEnjaminChaval.TroisCorpsWave.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/TroisCorpsWave.iss
#  git checkout installer/TroisCorpsWave.pkgproj
