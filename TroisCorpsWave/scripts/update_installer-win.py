...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TroisCorpsWave Demo Installer\n"
      else:
        line="OutputBaseFilename=TroisCorpsWave Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TroisCorpsWave Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TroisCorpsWave installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TroisCorpsWave Demo installer\n"
     else:
       line="SetupWindowTitle=TroisCorpsWave installer\n"
