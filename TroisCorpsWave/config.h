...
#define AUV2_ENTRY TroisCorpsWave_Entry
#define AUV2_ENTRY_STR "TroisCorpsWave_Entry"
#define AUV2_FACTORY TroisCorpsWave_Factory
#define AUV2_VIEW_CLASS TroisCorpsWave_View
#define AUV2_VIEW_CLASS_STR "TroisCorpsWave_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "TroisCorpsWave\nIPEF"
